...
environment = os.getenv("WEDDING_SITE_ENVIRONMENT", "development")
...
ALLOWED_HOSTS = ['localhost', 'kevinandkayla.com', 'www.kevinandkayla.com']
...
SECRET_KEY = '$de9=$ug1dy=z!%fusi+s$$g4npm-@82e*!bp^(7i=e-q+ml3!'
